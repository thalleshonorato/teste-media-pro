...
import com.mediapro.prova.services.CompetitionV2Service;
...
@Api("Api Competitions V2")
@CrossOrigin(origins="*")
public class CompetitionV2Controller {
	
    Logger logger = LoggerFactory.getLogger(CompetitionV2Controller.class);
	
	@Autowired
	private CompetitionV2Service competitionService;
